...
TO-DO using [Nest](https://github.com/nestjs/nest) framework repository.
...
The data is stored in a sqlite in memory database. <br>
...
You can see the swagger at ```/aerq/api```<br>
