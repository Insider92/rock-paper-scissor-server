...
describe('Match Controller (e2e)', () => {
  ...
  describe('match modul', () => {
    ...
    describe('challenge human', () => {
      it('should start a challenge versus another human user', async () => {
        const challenge = {
      ...
      it('should return an error for not valid choice id', async () => {
        ...
        const expectedErrorRequest = {
          message: `There is no valid choice with id ${randomID}`,
          statusCode: 404,
        };
        ...
        return request(app.getHttpServer())
          ...
          .expect(404)
          .expect(({ body }) => {
            expect(body).toEqual(expectedErrorRequest);
          });
      });

      it('should return an error for not valid user id', async () => {
        const randomID = randomUUID();

        const challenge = {
          challengedUser: randomID,
          choice: 'c907bbd9-f4f0-4344-a72a-ba58031e057d', // rock
        };

        const expectedErrorRequest = {
          message: `There is no valid user with id ${randomID}`,
          statusCode: 404,
        };
      ...
      it('should return an error for challenging yourself', async () => {
        const challenge = {
          challengedUser: '037cf399-fb47-4437-b1a8-9ee21255f4cf', // user1
          choice: 'c907bbd9-f4f0-4344-a72a-ba58031e057d', // rock
        };
    ...
    describe('should answer another human challenge ', () => {
      it('WIN', async () => {
        const newOngoingMatch = {
          id: '28732c6d-869a-463d-a8b5-2aa781bba0e1',
          status: Status.ONGOING,
      ...
      it('should return an error for not being the challenged user', async () => {
        const newOngoingMatch = {
          id: '28732c6d-869a-463d-a8b5-2aa781bba0e1',
          status: Status.ONGOING,
          opponentType: OpponentType.HUMAN,
        ...
        const expectedErrorRequest = {
          message: `You are not authorized to play this match`,
          statusCode: 401,
        };
      ...
      it('should return an error that the match is already finished', async () => {
        const newFinishedMatch = {
          id: '4141e34b-8a62-4bc6-8ef3-2091c8892f94',
          status: Status.FINISHED,
          opponentType: OpponentType.HUMAN,
        ...
        const expectedErrorRequest = {
          message: `The match with id ${newFinishedMatch.id} is already finished - you can't update your choice anymore`,
          statusCode: 404,
        };

        return request(app.getHttpServer())
          .put(`/v1/match/${newFinishedMatch.id}`)
          .set('Authorization', 'bearer ' + token1)
          .send(challengeAnswer)
          .set('Accept', 'application/json')
          .expect(404)
    ...
    describe('should return the result of the challenge of the computer', () => {
      it('WIN', async () => {
